...
module rob #(
    ...
    input  wire [31:0] issue_instr,      // <--- THIS WAS MISSING
    ...
    output reg  [31:0] commit_instr,     // <--- THIS WAS MISSING
    ...
    reg [31:0] instrs         [0:ENTRIES-1]; // <--- THIS WAS MISSING
