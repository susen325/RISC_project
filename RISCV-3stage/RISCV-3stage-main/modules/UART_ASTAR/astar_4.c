...
static inline uint32_t safe_hw_mandist(int r1, int c1, int r2, int c2) {
    int r_max = r1 > r2 ? r1 : r2; int r_min = r1 < r2 ? r1 : r2;
    int c_max = c1 > c2 ? c1 : c2; int c_min = c1 < c2 ? c1 : c2;
...
int main() {
    ...
    int start_r = 0, start_c = 0;   // Top Left
    int goal_r = 7, goal_c = 0;     // Bottom Left
    ...
    // THE ZIG-ZAG WALLS
    // Row 1: Blocks 0 to 6 (Gap at 7)
    grid[8]=1; grid[9]=1; grid[10]=1; grid[11]=1; grid[12]=1; grid[13]=1; grid[14]=1;
    // Row 3: Blocks 1 to 7 (Gap at 0)
    grid[25]=1; grid[26]=1; grid[27]=1; grid[28]=1; grid[29]=1; grid[30]=1; grid[31]=1;
    // Row 5: Blocks 0 to 6 (Gap at 7)
    grid[40]=1; grid[41]=1; grid[42]=1; grid[43]=1; grid[44]=1; grid[45]=1; grid[46]=1;
